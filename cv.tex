...
\section{Working Experiences}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Computer Vision Lab, Pohang University of Science and Technology \textnormal{(\textbf{POSTECH})}}{April. 2019 -- Present}
        \resumeItemListStart
            \resumeItem{Principal investigator tackling various computer vision problems}
            \resumeItem{3D scene understanding and generative models}
        \resumeItemListEnd
    \resumeSubheading
      ...
      {Intelligent Systems Lab, Intel}{Dec. 2015 -- March 2019}
        \resumeItemListStart
            ...
            \resumeItem{Co-founder of Open3D. 3D vision projects}
        \resumeItemListEnd
...
\section{Awards}
\resumeItemListStart
    \resumeItem{Best EduTech Award, POSTECH, Oct. 2021}
    ...
    \resumeItem{Outstanding Online Class Award, Awarded to five classes among 170 classes, POSTECH, July 2020}
