...
\resumePublicationListStart
    \publicationItem{Juyong Lee, Seokjun Ahn, and \textbf{Jaesik Park}}{Style-Agnostic Reinforcement Learning}{European Conference on Computer Vision (\textbf{ECCV}), 2022}{}
    \publicationItem{Jaesung Choe*, Chunghyun Park*, Francois Rameau, \textbf{Jaesik Park}, and In So Kweon}{PointMixer: MLP-Mixer for Point Cloud Understanding}{European Conference on Computer Vision (\textbf{ECCV}), 2022}{(*Equal contribution)}
    \publicationItem{Jaewon Kam, Jungeon Kim, Soongjin Kim, \textbf{Jaesik Park}, and Seungyong Lee}{CostDCNet: Cost Volume based Depth Completion for a Single RGB-D Image}{European Conference on Computer Vision (\textbf{ECCV}), 2022}{}
    \publicationItem{MinGuk Kang, Joonghyuk Shin, and \textbf{Jaesik Park}}{StudioGAN: A Taxonomy and Benchmark of GANs for Image Synthesis}{2206.09479 (arXiv), 2022}{}
    \publicationItem{Jinhwi Lee, Jungtaek Kim, Hyunsoo Chung, \textbf{Jaesik Park}, and Minsu Cho}{Learning to Assemble Geometric Shapes}{International Joint Conference on Artificial Intelligence (\textbf{IJCAI}), 2022}{}
    \publicationItem{Hyunmin Lee and \textbf{Jaesik Park}}{Instance-wise Occlusion and Depth Orders in Natural Scenes}{International Conference on Computer Vision and Pattern Recognition (\textbf{CVPR}), 2022}{}
    \publicationItem{Chunghyun Park, Yoonwoo Jeong, Minsu Cho, and \textbf{Jaesik Park}}{Fast Point Transformer}{International Conference on Computer Vision and Pattern Recognition (\textbf{CVPR}), 2022}{}
    \publicationItem{Jaebong Jeong, Janghun Jo, Sunghyun Cho, and \textbf{Jaesik Park}}{3D Scene Painting via Semantic Image Synthesis}{International Conference on Computer Vision and Pattern Recognition (\textbf{CVPR}), 2022}{}
    \publicationItem{Jungeon Kim, Hyomin Kim, Hyeonseo Nam, \textbf{Jaesik Park}, and Seungyong Lee}{TextureMe: High-quality Textured Scene Reconstruction in Real-time}{ACM Transactions on Graphics (\textbf{ToG}), 2022}{(will be presented at \textbf{SIGGRAPH2022})}
    ...
    \publicationItem{Wei Dong*, Kwonyoung Ryu*, Michael Kaess, and \textbf{Jaesik Park}}{Revisiting LiDAR Registration and Reconstruction: A Range Image Perspective}{2112.02779 (arXiv), 2021}{(*Equal contribution)}
...
Domestic
\resumePublicationListStart
    \publicationItem{Seokjun Ahn, Jinwhi Lee, Jungtaek Kim, Suhyeon Jeong, Seungwook Kim, \textbf{Jaesik Park}, and Minsu Cho}{탐색 알고리즘을 활용한 순차적 조각 조립}{제 34회 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 2022}{}
    \publicationItem{Jaewon Kam, Jungeon Kim, Soongjin Kim, \textbf{Jaesik Park}, and Seungyoung Lee}{실내 깊이 완성을 위한 3D 합성곱 기반의 절두체 합성곱}{제 34회 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 2022}{}
    \publicationItem{Wonjun Jin, Soongjin Kim, \textbf{Jaesik Park}, Seungyoung Lee, and Sunghyun Cho}{GC-NeRF: 형상 제약을 활용한 효율적인 NeRF 학습}{제 34회 영상처리 및 이해에 관한 워크샵 (IPIU), Feb. 2022}{}
