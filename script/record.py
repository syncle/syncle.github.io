...
class Record:
	def __init__(self, year = '', image='', title='', author='', venue='', pdf='', code='', data='', web='', web_inplace='', video='', supp='', comment = '', bibtex='', executable='', poster='', tutorial='', status='', category=''):
		self.special_year = -1
		self.image = image
		self.title = title
		self.author = author
