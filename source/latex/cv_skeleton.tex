...
\section{Working Experiences}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Pohang University of Science and Technology \textnormal{(\textbf{POSTECH})}}{Sep. 2022 -- Present}
      \resumeItemListStart
      ...
      \resumeItem{Proposed novel image generation pipelines: \textbf{StudioGAN} project (\textbf{3.0k GitHub stars})}
      \resumeItem{5.4k Google Scholar citations}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      {Intelligent Systems Lab, Intel (Manager: Dr. Vladlen Koltun)}{Dec. 2015 -- March 2019}
        \resumeItemListStart
          \resumeItem{\textbf{Co-creator of Open3D}: open-sourced 3D vision library that is built from scratch (\textbf{7.6+1.1k GitHub stars})}
