  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Pohang University of Science and Technology \textnormal{(\textbf{POSTECH})}}{April. 2019 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Proposed novel image generation pipelines: \textbf{StudioGAN} project (2.5k GitHub stars)}
    ...
    \resumeSubheading
      ...
      {Intelligent Systems Lab, Intel (Manager: Dr. Vladlen Koltun)}{Dec. 2015 -- March 2019}
        \resumeItemListStart
          \resumeItem{\textbf{Co-founder of Open3D}: open-sourced 3D vision library, built from scratch (6.4k GitHub stars)}
