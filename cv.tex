    ...
    \resumeSubheading
      ...
      {Pohang University of Science and Technology \textnormal{(\textbf{POSTECH})}}{April. 2019 -- Present}
        \resumeItemListStart
          ...
          \resumeItem{Proposed novel image generation pipelines: \textbf{StudioGAN} project (2.4k GitHub stars)}
          \resumeItem{4.3k Google Scholar citations}
        \resumeItemListEnd
    \resumeSubheading
      {Staff Research Scientist}{Santa Clara, CA, USA}
      {Intelligent Systems Lab, Intel (Manager: Dr. Vladlen Koltun)}{Dec. 2015 -- March 2019}
        \resumeItemListStart
          \resumeItem{\textbf{Co-founder of Open3D}: open-sourced 3D vision library, built from scratch (6.0k GitHub stars)}
...
\resumePublicationListStart
    \publicationItem{Jaesung Choe, Byeongin Joung, Francois Rameau, \textbf{Jaesik Park}, and In So Kweon}{Deep Point Cloud Reconstruction}{International Conference on Learning Representations (\textbf{ICLR}), 2022}{}
    \publicationItem{Jae Shin Yoon, Zhixuan Yu, \textbf{Jaesik Park}, and Hyun Soo Park}{HUMBI: A Large Multiview Dataset of Human Body Expressions and Benchmark Challenge}{Transactions on Pattern Analysis and Machine Intelligence (\textbf{TPAMI}), 2021}{}
    ...
    \publicationItem{Chunghyun Park, Yoonwoo Jeong, Minsu Cho, and \textbf{Jaesik Park}}{Fast Point Transformer}{2112.04702 (arXiv), 2021}{}
...
\resumeItemListStart
    ...
    \resumeItem{\textit{Point Cloud Registration using Hierachical Hough Transform}, 33nd Workshop on Image Processing and Image Understanding (IPIU2021), Virtual, Feb. 2021}
