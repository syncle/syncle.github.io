...
run_and_check_success "gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.5 -dNOPAUSE -dQUIET -dBATCH -dPrinted=false -sOutputFile=../cv_jaesik_park.pdf ../cv_jaesik_park.pdf"
