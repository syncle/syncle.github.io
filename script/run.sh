...
run_and_check_success "pdflatex --interaction=batchmode --jobname=cv -output-directory .. ../cv.tex 2>&1 > /dev/null"
run_and_check_success "gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.5 -dNOPAUSE -dQUIET -dBATCH -dPrinted=false -sOutputFile=../cv_jaesik_park.pdf ../cv.pdf"
run_and_check_success "rm ../cv.pdf"
