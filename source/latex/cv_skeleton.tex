...
\section{Working Experiences}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItem{5.9k Google Scholar citations}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      {Intelligent Systems Lab, Intel (Manager: Dr. Vladlen Koltun)}{Dec. 2015 -- March 2019}
        \resumeItemListStart
          \resumeItem{\textbf{Co-creator of Open3D}: open-sourced 3D vision library that is built from scratch (\textbf{7.7+1.1k GitHub stars})}
